            ...
            <div class="main-content__wrap">
                    ...
                    if (have_posts()) :
                        while (have_posts()) : the_post();
                            ...
                            <h3 class="article-title">
                                <?php echo get_the_title($page_post); ?></h3>
                            ...
                            <?php if (get_post_meta($page_id, 'source', 1)) { ?>
                                <div class="source-wrap">
                                    <p>Источник: </p>
                                    <a href="<?php echo get_post_meta($page_id, 'source_link', 1) ?>">
                                        <?php echo get_post_meta($page_id, 'source', 1) ?>
                                    </a>
                                </div>
                                <?php
                            }
                ...
                <div class="main-content__right">
                    ...
                    <div class="schedule">
                        ...
                        ?>
                        <a href="<?php echo get_home_url() . '/article' ?>" class="btn-all-news">Все публикации</a>
                    </div>
                </div>
            </div>
        </div>
